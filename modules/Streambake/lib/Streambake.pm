...
Streambake - A Perl-based HTTP audio file streamer.
...
Please do not e-mail the module author directly; you will be politely asked to
send an e-mail to the mailing list instead.
