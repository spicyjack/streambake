...
# for this project: https://github.com/spicyjack/streambake/issues

=head1 NAME

B<file_reporter.pl> - Report information about files that are interesting to
C<Streambake>.
...
=head1 SYNOPSIS
 ...
 file_reporter.pl --catalog /path/to/UralCatalog.xls \
...
B<file_reporter.pl> - Create a report that shows different bits of information
about files that could be used with C<Streambake> (MP3, OGG, FLAC, JPG, PNG,
etc.)
...
#    } # if ( $Config->get(q(o_colorlog)) )
    ...
    # print a nice banner
    $log->info(qq(Starting file_reporter.pl, version $VERSION));
...
C<< <https://github.com/spicyjack/streambake/issues> >>

=head1 SUPPORT

You can find documentation for this script with the perldoc command.

    perldoc file_reporter.pl
